...
Di seguito è riportata la stima delle ore previste rispetto a quelle
effettivamente impiegate per lo sviluppo del progetto.

::: center
  **Fase di Sviluppo**                   **Ore Previste**   **Ore Effettive**
  ------------------------------------- ------------------ -------------------
  Analisi e progettazione UML                   7                  10
  Implementazione Modello Logico                15                 17
  Implementazione Interfaccia Grafica           10                 10
  Integrazione e Debugging                      5                   8
  Stesura Relazione                             3                   3
  **Totale**                                  **40**             **48**
:::

Come si può notare dalla tabella della rendicontazione, il totale delle
ore effettive è superiore rispetto a quanto era stato preventivato
all'inizio del progetto. Questo sforamento è stato causato
principalmente da due fattori:

- **Progettazione e scelta dei Design Pattern:** La fase iniziale di
  studio ha richiesto più tempo del previsto. Scegliere i pattern adatti
  e capire come applicarli concretamente alla struttura delle classi ha
  richiesto diverse ricerche, si è preferito dedicare maggiore tempo a
  questa parte rispetto a riscrivere il codice in seguito.

- **Complicazioni nel Debugging:** Durante la fase di testing sono
  emersi alcuni problemi complessi e imprevisti che hanno portato a
  lunghe sessioni di modifica del codice in più punti.

- **Modello logico:** La scelta di riutilizzare gli stessi pulsanti
  grafici per più modalità diverse (es. pulsante conferma per aggiunta e
  modifica di attività e sotto-attività) ha reso più semplice la
  composizione grafica ma più complicata la gestione tecnica del codice.

Anche se il monte ore iniziale è stato superato, è stato fondamentale
per correggere tutti i bug critici e consegnare un'applicazione stabile
e robusta.
